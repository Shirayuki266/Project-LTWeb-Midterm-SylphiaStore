...
<body>
    ...
    <div class="center-panel">
        ...
        <form class="product-form">
            ...
            <input type="text" id="loai" name="loinhuan" placeholder="Nhập Mã Loại" value="L01" required />

            <label for="ten">Tên Loại Sản Phẩm</label>
            <input type="text" id="loai" name="loinhuan" placeholder="Nhập Tên Loại" value="Điện Thoại" required />
            <hr class="divider" />
