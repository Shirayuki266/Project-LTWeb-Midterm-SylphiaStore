...
<body>
    ...
    <div class="center-panel">
        <h2>Sửa Lợi Nhuận Sản Phẩm</h2>
        <form class="product-form">
            <label for="ten">Tên Sản Phẩm</label>
            <input type="text" id="loinhuan" name="loinhuan" placeholder="Nhập Tên Sản Phẩm" value="Iphone 17 Pro Max"
                required />
            ...
            <input type="text" id="loinhuan" name="loinhuan" placeholder="Nhập giá vốn sản phẩm" value="30,000,000"
                required />
            <hr class="divider" />
